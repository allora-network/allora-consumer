...
/* tslint:disable */
/* eslint-disable */
export * as alloraConsumerTSol from "./AlloraConsumer.t.sol";
export * as alloraConsumerAdminTSol from "./AlloraConsumerAdmin.t.sol";
...
export { AlloraConsumer__factory } from "./AlloraConsumer__factory";
export { AlloraConsumerBringPredictionOnChainExample__factory } from "./AlloraConsumerBringPredictionOnChainExample__factory";
...
export { IAlloraConsumer__factory } from "./IAlloraConsumer__factory";
